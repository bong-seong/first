	...
	- JAVA / JS : 객체 지향 언어 [ OOP : Object Oriented Programming ]
		1. 메모리/저장소
			...
			3. 배열 : let 배열명 = [ 데이터1, 데이터2, 데이터3 ]		[ 데이터 여러개 ]
				- 문제점 : 서도 다른 데이터 유형들을 한번에 저장시 식별이 어려움
				* 유재석/강호동/신동엽의 아이디, 비밀번호 , 이름 저장
					유재석 : qweqwe, 1234 , 유재석
					강호동 : asdasd, 456 	, 강호동
					신동엽 : zxczxc, 789 	, 신동엽
					
				let 배열명 = [ qweqwe, 1234, 유재석,
							 asdasd, 456 , 강호동, 
							 zxczxc, 789 , 신동엽 ]
...
객체1.연락처 = '010-1234-5600'; 	console.log( 객체1 );
...
// 6. 배열과 객체 관계 [ 배열안에 객체저장가능 / 객체 안에 배열 저장 가능 ]
