	...
	<center>
		...
		<form name="voteForm" action="/HRD_3/vote" method="post">
			<table border="1" style="border-collapse: collapse; width: 700px;">
				...
				<tr>
					<th> 주민번호 </th> <th> <input type="text" name="v_jumin"> 예 : 8906153154726 </th>
				</tr>
				
				<tr>
					<th> 성명 </th> <th> <input type="text" name="v_name"> </th>
				</tr>
				...
				<tr>
					<th> 투표시간 </th> <th> <input type="text" name="v_time" placeholder="예)0930"> </th>
				</tr>
				<tr>
					<th> 투표장소 </th> <th> <input type="text" name="v_area" placeholder="예)제1투표장"> </th>
				</tr>
				<tr>
					<th> 유권자확인 </th> 
					<th> 
