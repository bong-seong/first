...
public class Ex1_p529 {
	public static void main(String[] args) {
		...
		// String.format("%.소수자리수f" , 값 ) : 반올림가능하지만 문자열이됨 
		...
		// p.531 로또
			...
			// 배열/리스트 : 동일한 자료형의 데이터 여러개 저장하기 위한 리스트/배열 
		// int 형 변수를 6개 저장할 수 있는 배열 [ 고정길이 , 메소드제공x ]
		int[] selectNumber = new int[6]; 
			// vs
		// int형 변수를 6개 저장할 수 있는 리스트 [ 가변길이 , 메소드제공o , 기본길이 ]
		// ArrayList< int > -> 불가능
		...
		// 배열 정렬
			// 1. Arrays.sort( 배열 ) : 해당 배열내 데이터를 오름차순 정렬
		...
		if( result ) { System.out.println( "1등입니다." ); } 
		else { System.out.println("노당첨"); }
