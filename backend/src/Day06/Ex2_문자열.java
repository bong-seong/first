...
public class Ex2_문자열 { // class START
	...
	public static void main(String[] args) { // main START 
		...
		// if( hobby2.equals(null)) { System.out.println(" null 객체");} // 오류발생
		if( hobby2 == null ) { System.out.println("null");}
		...
		System.out.println( ssn2.substring( 0 , 6 ) ); // 0 부터 6 인덱스 전까지
