...
import java.util.Scanner; // Scanner 클래스를 사용하기 위한 Scanner 클래스 import 가져오기
...
public class Ex2_입력 {
	...
	public static void main(String[] args) {
		...
		// 1. [p.70] 입력
			...
			// 입력 객체 : Scanner 변수명 = new Scanner ( System.in );
				// { } 지역별 1번 
		...
		String 문자열1 = scanner.next(); 			System.out.println("문자열1 : " + 문자열1 );
			// 2. 문자열[띄어쓰기 가능] 입력받기 함수 / [ .nextLine() 앞에 다른 next() 하나로 취급 -> 해결방안 : 앞에 .nextLine() 작성
