...
// ! : 자바는 무조건 class 단위 
	// 자바를 100% 객체지향		// js : 함수단위
	// 클래스 기반으로 메모리 할당 : 객체
	// 클래스 : 객체 설계도 
public class Ex1_출력 { // class START
	
	// * main 함수 : main 스레드 [ 스레드 : 실행 주체 ]
	public static void main(String[] args) {
		// 1. [ p.67 ] syso + 컨트롤 + 스페이스바
		System.out.println();
		...
		System.out.println("\"println 함수2\""); // 출력후 \n
			...
			/*
			 	형식문자열
			 	 	%d : 정수
			 	 		...
			 	 		%0자릿수d 	오른쪽부터 자릿수 차지 [ 만일 자리수에 데이터 없으면 0으로 대체 출력 ] 
			 	 	%f : 실수
			 	 		%자릿수.소수자리수
			 	 	%s : 문자열
